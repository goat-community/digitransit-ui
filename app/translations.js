...
const translations = {
  da: {
    ...
    'default': 'Standard (without restriction)',
    'wheelchair': 'Kørestol',
    'rollator': 'Rollator',
  ...
  de: {
    ...
    'bicycle_frame_lock': 'Rahmenschloss',
    'bus-express': 'Express-Bus',
    'bus-local': 'Bürgerbus',
    'carpool-with-route-number': 'Fahrgemeinschaft {routeNumber} nach {headsign}',
    'citybike-return-full': 'Leihrad zurückgeben?',
    'citybike-return-full-link': 'Rückgabe, falls Station vollständig belegt ist›',
    'copy-code': 'Code kopieren',
    'covered': 'Überdacht',
    'create-stop-monitor': 'Abfahrtsmonitor erstellen',
    'delete-favourite-failed-heading': 'Löschen nicht möglich',
    'departure-page-sr': 'Informationen zu Fahrt {shortName} {destination} {time}',
    'departures-not-found': 'Leider haben wir für die gewählte Haltestellen keine Abfahrtszeiten gefunden',
    'departures-not-found-time-threshold': 'Leider haben wir für die gewählte Haltestellen keine Abfahrtszeiten gefunden. Es kann sein, dass der gewählte Tag zu weit in der Zukunft liegt. Bitte versuchen Sie es zu einem Zeitpunkt erneut, der näher an Ihrem Reisezeitpunkt liegt.',
    'disruptions-and-diversions': 'Störungen und Umleitungen',
    'engine_ignition_aid': 'Engine starting aid',
    'english': 'Englisch',
    'favourite-failed-text': 'Versuchen Sie es später noch einmal.',
    'finnish': 'Finnisch',
    ...
    'itinerary-in-the-past-title': 'Die Verbindungsoptionen können nicht angezeigt werden',
    'itinerary-summary.bikeAndPublic-fallback-title': 'Nehmen Sie Ihr Rad mit aan Bord',
    'itinerary-summary.bikeAndPublic-rail-subway-title': 'Nehmen Sie Ihr Rad mit in die Bahn',
    'itinerary-summary.bikeAndPublic-rail-title': 'Nehmen Sie Ihr Rad mit in die Bahn',
    'itinerary-summary.bikeAndPublic-subway-title': 'Nehmen Sie Ihr Rad mit in die U-Bahn',
    ...
    'nearest-stops-favorite': 'Haltestellen in der Nähe',
    'no-route-found': 'Leider konnten wir Linie {shortName} ({longName}) nicht finden.',
    'no-route-msg-time-threshold': 'Leider konnten wir keine Verbindungsvorschläge ermitteln. Es ist möglich, das noch noch keine Fahrplandaten für den von Ihnen gewählten Tag vorliegen. Bitte versuchen Sie es einige Tage vor Ihrer Abfahrt erneut.',
    'notification-minimize': 'Nachricht schließen',
    'notification-open': 'Nachricht öffnen',
    'option-less': 'Calm',
    'option-more': 'Prompt',
    'paid': 'Bezahlt',
    'payment_at_gate': 'Bezahlung am Tor ',
    'position': 'Position',
    'privacy-statement': 'Datenschutzerklärung',
    'read-more': 'Weiter lesen',
    'regiorad-start-using': 'Leihrad buchen',
    'route-page-vehicle-selected': 'Aktuelle Auswahl.',
    'route-page.future-routes': 'Zukünftigen Verbindungen',
    'route-page.pattern-chosen': 'Ausgewählt',
    'route-page.pattern-select-title': 'Anzuzeigene Verbindung auswählen',
    'route-to-ferry': 'Verbindung zum Pier',
    'route-to-park': 'Verbindung zur Parkmöglichkeit',
    'route-to-station': 'Verbindung zum Bahnhof',
    'router-change-departure-time': 'Abfahrtszeit ändern ›',
    'select-all-routes': 'All Linien auswählen',
    'select-from-map-favourite': 'Von Karte auswählen',
    'select-route': 'Wähle {mode}verbindung {shortName} nach {headsign}',
    'selected-routes': 'Wähle Verbindungen',
    'settings-alternative-name-rail': 'Zug',
    'settings-change-itinerary-settings': 'Einstellungen ändern',
    'settings-missing-itineraries-body': 'Einige gewählte Einstellungen schließen alternative Routen aus.',
    'settings-missing-itineraries-header': 'Fehlen alternative Routen?',
    'stadtrad-start-using': 'Leihrad buchen',
    'stop-near-you': 'Haltestellung und Linien in der Nähe suchen',
    'stop-near-you-update-alert': 'Nächste Haltestellen aktualisiert',
    'surveillance_cameras': 'Überwachungskameras',
    'swedish': 'Swedisch',
    'to-rail': 'Zug',
    'to-subway': 'U-Bahn',
    'userinfo': 'Meine Informationen',
    'usermenu': 'Benutzermenü',
    'vr_ticket': 'VR Ticket',
    'zone-unknown': 'Unbekannte Zone',
    ...
    'bicycle-walk-from-transit-no-duration': 'Steigen Sie mit dem Fahrrad aus dem {transportMode} aus',
    'bicycle-walk-to-transit': 'Schieben Sie ihr Fahrrad {distance} ({duration}) und steigen Sie mit ihm in den/die {transportMode}',
    'bicycle-walk-to-transit-no-duration': 'Schieben Sie ihr Fahrrad zum/zur {transportMode}',
    ...
    destination: 'Zielort',
    'destination-defined': 'Zielort festgelegt',
    ...
    'embedded-search.choose-language': 'Sprache',
    'embedded-search.choose-mode': 'Verkehrsmittel',
    'embedded-search.choose-width-component': 'Breite des eingebetteten Widgets',
    'embedded-search.form-heading': 'Einbettungs-Werkzeuge',
    ...
    'origin-defined': 'Startort festgelegt',
    ...
    'default': 'Standard (ohne Einschränkung)',
    'wheelchair': 'Rollstuhl',
    'rollator': 'Rollator',
    'slight-walking-disability': 'Leichte Gehbehinderung',
    'visual-impairment': 'Sehbehinderung',
 ...
 pl: {
    ...
    'default': 'Standard (bez ograniczeń)',
